...
import { analyze, classify } from './jwt.js';
...
const HEADINGS: ReportHeadings = {
  sentinel: 'no unpinned JWT verification found\n',
  findings: 'Unpinned JWT verification found:',
};
...
const runCheck = (snippets: string[], lang: string | undefined): HookResult => {
  ...
  return {
    ...
    hasFinding: verdicts.includes('unpinned'),
  };
};
