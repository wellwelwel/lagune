...
import { analyze, classify } from './crypto.js';
...
const HEADINGS: ReportHeadings = {
  sentinel: 'no weak cryptography found\n',
  findings: 'Weak cryptography found:',
  review: 'Cryptography to review manually:',
};
...
const runCheck = (snippets: string[], lang: string | undefined): HookResult => {
  ...
  return {
    ...
    hasFinding: verdicts.includes('weak'),
  };
};
