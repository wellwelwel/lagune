...
This is the same check the [`regex` sub-skill](/docs/commands/skills) runs to keep only the safe patterns. You can also try a pattern in the browser at [**devina.io/redos-checker**](https://devina.io/redos-checker).
:::
