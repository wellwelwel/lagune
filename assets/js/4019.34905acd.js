"use strict";(self.webpackChunkwebsite=self.webpackChunkwebsite||[]).push([["4019"],{9526(t,e,i){i.d(e,{A:()=>n});var r=i(4848);i(6540);var o=i(9863);function n({children:t,fallback:e}){return(0,o.A)()?(0,r.jsx)(r.Fragment,{children:t?.()}):e??null}},3385(t,e,i){i.d(e,{EJ:()=>w});var r=i(6540);let o=`#version 300 es
...
}`;function c(t){if(t.naturalWidth<1024&&t.naturalHeight<1024){if(t.naturalWidth<1||t.naturalHeight<1)return;let e=t.naturalWidth/t.naturalHeight;t.width=Math.round(e>1?1024*e:1024),t.height=Math.round(e>1?1024:1024/e)}}var h=i(4848);async function u(t){let e={},i=[];return Object.entries(t).forEach(([t,r])=>{if("string"==typeof r){let o=r||"data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";if(!(t=>{try{if(t.startsWith("/"))return!0;return new URL(t),!0}catch{return!1}})(o))return void console.warn(`Uniform "${t}" has invalid URL "${o}". Skipping image loading.`);let n=new Promise((i,r)=>{let n=new Image;(t=>{try{if(t.startsWith("/"))return!1;return new URL(t,window.location.origin).origin!==window.location.origin}catch{return!1}})(o)&&(n.crossOrigin="anonymous"),n.onload=()=>{c(n),e[t]=n,i()},n.onerror=()=>{console.error(`Could not set uniforms. Failed to load image at ${o}`),r()},n.src=o});i.push(n)}else r instanceof HTMLImageElement&&c(r),e[t]=r}),await Promise.all(i),e}let d=(0,r.forwardRef)(function({fragmentShader:t,uniforms:e,webGlContextAttributes:i,speed:o=0,frame:n=0,width:s,height:l,minPixelRatio:c,maxPixelCount:d,mipmaps:p,style:g,...f},m){var v;let x,y,[k,b]=(0,r.useState)(!1),_=(0,r.useRef)(null),w=(0,r.useRef)(null),S=(0,r.useRef)(i);(0,r.useEffect)(()=>((async()=>{let i=await u(e);_.current&&!w.current&&(w.current=new a(_.current,t,i,S.current,o,n,c,d,p),b(!0))})(),()=>{w.current?.dispose(),w.current=null}),[t]),(0,r.useEffect)(()=>{let t=!1;return(async()=>{let i=await u(e);t||w.current?.setUniforms(i)})(),()=>{t=!0}},[e,k]),(0,r.useEffect)(()=>{w.current?.setSpeed(o)},[o,k]),(0,r.useEffect)(()=>{w.current?.setMaxPixelCount(d)},[d,k]),(0,r.useEffect)(()=>{w.current?.setMinPixelRatio(c)},[c,k]),(0,r.useEffect)(()=>{w.current?.setFrame(n)},[n,k]);let B=(v=[_,m],x=r.useRef(void 0),y=r.useCallback(t=>{let e=v.map(e=>{if(null!=e){if("function"==typeof e){let i=e(t);return"function"==typeof i?i:()=>{e(null)}}return e.current=t,()=>{e.current=null}}});return()=>{e.forEach(t=>t?.())}},v),r.useMemo(()=>v.every(t=>null==t)?null:t=>{x.current&&(x.current(),x.current=void 0),null!=t&&(x.current=y(t))},v));return(0,h.jsx)("div",{ref:B,style:void 0!==s||void 0!==l?{width:"string"==typeof s&&!1===isNaN(+s)?+s:s,height:"string"==typeof l&&!1===isNaN(+l)?+l:l,...g}:g,...f})});d.displayName="ShaderMount";let p={fit:"contain",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0},g={none:0,contain:1,cover:2};function f(t){if(Array.isArray(t))return 4===t.length?t:3===t.length?[...t,1]:v;if("string"!=typeof t)return v;let e,i,r,o=1;if(t.startsWith("#")){var n;[e,i,r,o]=(3===(n=(n=t).replace(/^#/,"")).length&&(n=n.split("").map(t=>t+t).join("")),6===n.length&&(n+="ff"),[parseInt(n.slice(0,2),16)/255,parseInt(n.slice(2,4),16)/255,parseInt(n.slice(4,6),16)/255,parseInt(n.slice(6,8),16)/255])}else if(t.startsWith("rgb")){let n;[e,i,r,o]=(n=t.match(/^rgba?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([0-9.]+))?\s*\)$/i))?[parseInt(n[1]??"0")/255,parseInt(n[2]??"0")/255,parseInt(n[3]??"0")/255,void 0===n[4]?1:parseFloat(n[4])]:[0,0,0,1]}else{let n;if(!t.startsWith("hsl"))return console.error("Unsupported color format",t),v;[e,i,r,o]=function(t){let e,i,r,[o,n,a,s]=t,l=o/360,c=n/100,h=a/100;if(0===n)e=i=r=h;else{let t=(t,e,i)=>(i<0&&(i+=1),i>1&&(i-=1),i<1/6)?t+(e-t)*6*i:i<.5?e:i<2/3?t+(e-t)*(2/3-i)*6:t,o=h<.5?h*(1+c):h+c-h*c,n=2*h-o;e=t(n,o,l+1/3),i=t(n,o,l),r=t(n,o,l-1/3)}return[e,i,r,s]}((n=t.match(/^hsla?\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(?:,\s*([0-9.]+))?\s*\)$/i))?[parseInt(n[1]??"0"),parseInt(n[2]??"0"),parseInt(n[3]??"0"),void 0===n[4]?1:parseFloat(n[4])]:[0,0,0,1])}return[m(e,0,1),m(i,0,1),m(r,0,1),m(o,0,1)]}let m=(t,e,i)=>Math.min(Math.max(t,e),i),v=[0,0,0,1],x=`
