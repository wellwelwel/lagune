"use strict";(self.webpackChunkwebsite=self.webpackChunkwebsite||[]).push([["2213"],{7748(e,t,i){i.d(t,{EJ:()=>d});var r=i(6540);let o=`#version 300 es
...
}`;function u(e){if(e.naturalWidth<1024&&e.naturalHeight<1024){if(e.naturalWidth<1||e.naturalHeight<1)return;let t=e.naturalWidth/e.naturalHeight;e.width=Math.round(t>1?1024*t:1024),e.height=Math.round(t>1?1024:1024/t)}}var h=i(4848);async function c(e){let t={},i=[];return Object.entries(e).forEach(([e,r])=>{if("string"==typeof r){let o=r||"data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";if(!(e=>{try{if(e.startsWith("/"))return!0;return new URL(e),!0}catch{return!1}})(o))return void console.warn(`Uniform "${e}" has invalid URL "${o}". Skipping image loading.`);let a=new Promise((i,r)=>{let a=new Image;(e=>{try{if(e.startsWith("/"))return!1;return new URL(e,window.location.origin).origin!==window.location.origin}catch{return!1}})(o)&&(a.crossOrigin="anonymous"),a.onload=()=>{u(a),t[e]=a,i()},a.onerror=()=>{console.error(`Could not set uniforms. Failed to load image at ${o}`),r()},a.src=o});i.push(a)}else r instanceof HTMLImageElement&&u(r),t[e]=r}),await Promise.all(i),t}let g=(0,r.forwardRef)(function({fragmentShader:e,uniforms:t,webGlContextAttributes:i,speed:o=0,frame:a=0,width:n,height:l,minPixelRatio:u,maxPixelCount:g,mipmaps:m,style:f,...p},v){var d;let x,_,[R,S]=(0,r.useState)(!1),U=(0,r.useRef)(null),b=(0,r.useRef)(null),w=(0,r.useRef)(i);(0,r.useEffect)(()=>((async()=>{let i=await c(t);U.current&&!b.current&&(b.current=new s(U.current,e,i,w.current,o,a,u,g,m),S(!0))})(),()=>{b.current?.dispose(),b.current=null}),[e]),(0,r.useEffect)(()=>{let e=!1;return(async()=>{let i=await c(t);e||b.current?.setUniforms(i)})(),()=>{e=!0}},[t,R]),(0,r.useEffect)(()=>{b.current?.setSpeed(o)},[o,R]),(0,r.useEffect)(()=>{b.current?.setMaxPixelCount(g)},[g,R]),(0,r.useEffect)(()=>{b.current?.setMinPixelRatio(u)},[u,R]),(0,r.useEffect)(()=>{b.current?.setFrame(a)},[a,R]);let y=(d=[U,v],x=r.useRef(void 0),_=r.useCallback(e=>{let t=d.map(t=>{if(null!=t){if("function"==typeof t){let i=t(e);return"function"==typeof i?i:()=>{t(null)}}return t.current=e,()=>{t.current=null}}});return()=>{t.forEach(e=>e?.())}},d),r.useMemo(()=>d.every(e=>null==e)?null:e=>{x.current&&(x.current(),x.current=void 0),null!=e&&(x.current=_(e))},d));return(0,h.jsx)("div",{ref:y,style:void 0!==n||void 0!==l?{width:"string"==typeof n&&!1===isNaN(+n)?+n:n,height:"string"==typeof l&&!1===isNaN(+l)?+l:l,...f}:f,...p})});g.displayName="ShaderMount";var m=i(1893),f=i(5784),p=i(1676);let v={name:"Default",params:{...m.J7,scale:.8,speed:1,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:.07,layering:.5,edges:.8,waves:.3,caustic:.1,size:1}};m.J7,m.J7,m.J7;let d=(0,r.memo)(function({speed:e=v.params.speed,frame:t=v.params.frame,colorBack:i=v.params.colorBack,colorHighlight:r=v.params.colorHighlight,image:o="",highlights:a=v.params.highlights,layering:s=v.params.layering,waves:n=v.params.waves,edges:l=v.params.edges,caustic:u=v.params.caustic,effectScale:c,size:d=void 0===c?v.params.size:10/9/c-1/9,fit:x=v.params.fit,scale:_=v.params.scale,rotation:R=v.params.rotation,originX:S=v.params.originX,originY:U=v.params.originY,offsetX:b=v.params.offsetX,offsetY:w=v.params.offsetY,worldWidth:y=v.params.worldWidth,worldHeight:E=v.params.worldHeight,...A}){let B={u_image:o,u_colorBack:(0,f.G)(i),u_colorHighlight:(0,f.G)(r),u_highlights:a,u_layering:s,u_waves:n,u_edges:l,u_caustic:u,u_size:d,u_fit:m.Tk[x],u_rotation:R,u_scale:_,u_offsetX:b,u_offsetY:w,u_originX:S,u_originY:U,u_worldWidth:y,u_worldHeight:E};return(0,h.jsx)(g,{...A,speed:e,frame:t,fragmentShader:p.Z,mipmaps:["u_image"],uniforms:B})},function(e,t){for(let i in e){if("colors"===i){let i=Array.isArray(e.colors),r=Array.isArray(t.colors);if(!i||!r){if(!1===Object.is(e.colors,t.colors))return!1;continue}if(e.colors?.length!==t.colors?.length||!e.colors?.every((e,i)=>e===t.colors?.[i]))return!1;continue}if(!1===Object.is(e[i],t[i]))return!1}return!0})},5784(e,t,i){function r(e){if(Array.isArray(e))return 4===e.length?e:3===e.length?[...e,1]:a;if("string"!=typeof e)return a;let t,i,r,s=1;if(e.startsWith("#")){var n;[t,i,r,s]=(3===(n=(n=e).replace(/^#/,"")).length&&(n=n.split("").map(e=>e+e).join("")),6===n.length&&(n+="ff"),[parseInt(n.slice(0,2),16)/255,parseInt(n.slice(2,4),16)/255,parseInt(n.slice(4,6),16)/255,parseInt(n.slice(6,8),16)/255])}else if(e.startsWith("rgb")){let o;[t,i,r,s]=(o=e.match(/^rgba?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([0-9.]+))?\s*\)$/i))?[parseInt(o[1]??"0")/255,parseInt(o[2]??"0")/255,parseInt(o[3]??"0")/255,void 0===o[4]?1:parseFloat(o[4])]:[0,0,0,1]}else{let o;if(!e.startsWith("hsl"))return console.error("Unsupported color format",e),a;[t,i,r,s]=function(e){let t,i,r,[o,a,s,n]=e,l=o/360,u=a/100,h=s/100;if(0===a)t=i=r=h;else{let e=(e,t,i)=>(i<0&&(i+=1),i>1&&(i-=1),i<1/6)?e+(t-e)*6*i:i<.5?t:i<2/3?e+(t-e)*(2/3-i)*6:e,o=h<.5?h*(1+u):h+u-h*u,a=2*h-o;t=e(a,o,l+1/3),i=e(a,o,l),r=e(a,o,l-1/3)}return[t,i,r,n]}((o=e.match(/^hsla?\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(?:,\s*([0-9.]+))?\s*\)$/i))?[parseInt(o[1]??"0"),parseInt(o[2]??"0"),parseInt(o[3]??"0"),void 0===o[4]?1:parseFloat(o[4])]:[0,0,0,1])}return[o(t,0,1),o(i,0,1),o(r,0,1),o(s,0,1)]}i.d(t,{G:()=>r});let o=(e,t,i)=>Math.min(Math.max(e,t),i),a=[0,0,0,1]},1893(e,t,i){i.d(t,{J7:()=>r,Tk:()=>o});let r={fit:"contain",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0},o={none:0,contain:1,cover:2}},1676(e,t,i){i.d(t,{Z:()=>s});let r=`
